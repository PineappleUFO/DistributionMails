...
public partial class InputMailMain : ContentPage
{
    ...
    //    // Ïðîâåðÿåì, ïðîøëî ëè âðåìÿ, äîñòàòî÷íîå äëÿ ñ÷èòûâàíèÿ äâîéíîãî íàæàòèÿ
    //    var currentTime = DateTime.Now;
    //    var elapsedTime = currentTime - _lastTapTime;
    //    _lastTapTime = currentTime;

    //    // Åñëè ïðåäûäóùèé ýëåìåíò è òåêóùèé ýëåìåíò ñîâïàäàþò, è ïðîøëî ìàëî âðåìåíè,
    //    // ñ÷èòàåì ýòî äâîéíûì íàæàòèåì
    ...
    //    {
    //        //todo ñäåëàòü çíà÷îê çàãðóçêè
    //        //todo èíîãäà âûëåòàåò åñëè áûñòðî êëèêàòü
