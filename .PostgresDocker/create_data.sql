...
(
    mail_type_id   serial not null
        constraint mail_type_pk
            primary key,
    mail_type_name varchar
);

comment on table mail_type is 'тип письма';
...
comment on column public.incoming_mail.reply_required is ' требуется ли ответ';
...
insert into public.mail_type (mail_type_id, mail_type_name)
values  (1, 'Руководство приказы'),
        (2, 'Руководство конфидециальные'),
		(3, 'Общие');
COMMIT;


insert into public.incoming_mail (mail_id, number, date_input, date_answer, theme, responsible, id_project, id_sender, id_outgoing_mail, id_type, reply_required)
values  (3, '1003Э', '2023-04-10 11:00:00.000000', null, 'Проект согласования технической документации', null, 1, 3, 1, 1, null),
        (10, '1010Э', '2023-03-17 11:30:00.000000', null, 'Согласование технического задания', null, 3, 9, null, 1, null),
        (6, '1006Э', '2023-04-05 13:30:00.000000', null, 'Запрос на уточнение технических требований', null, 3, 4, null, 1, null),
        (42, '1042Э', '2023-03-27 11:30:00.000000', null, 'Запрос на разработку структурной схемы', null, 3, 1, null, 3, null),
        (38, '1038Э', '2023-04-03 13:30:00.000000', null, 'О необходимости проведения испытаний нагрузки', null, 3, 2, null, 3, null),
        (24, '1024Э', '2023-05-12 12:00:00.000000', null, 'Согласование эргономических параметров', null, 4, 6, null, 3, null),
        (34, '1034Э', '2023-05-17 10:30:00.000000', null, 'Согласование изменений в проекте конструкции', null, 3, 1, null, 3, null),
        (1, '1001Э', '2023-02-15 09:30:00.000000', null, 'По вопросу модификации конструкции', 157, 2, 5, 6, 3, true),
        (5, '1005Э', '2023-03-28 10:00:00.000000', null, 'Согласование изменений в чертежах', null, 2, 7, 5, 3, true),
        (20, '1020Э', '2023-03-30 16:15:00.000000', null, 'Запрос на разработку нового модуля', null, 4, 4, null, 2, true),
        (14, '1014Э', '2023-01-15 16:30:00.000000', null, 'Запрос на расчет прочности конструкции', null, 3, 10, null, 2, null),
        (16, '1016Э', '2023-04-12 12:45:00.000000', null, 'О необходимости доработки узла', null, 4, 8, null, 2, null),
        (28, '1028Э', '2023-02-10 10:15:00.000000', null, 'Запрос на предоставление технической документации', null, 4, 8, null, 3, null),
        (17, '1017Э', '2023-02-25 15:00:00.000000', null, 'Запрос на обновление проектной документации', null, 2, 5, null, 3, null),
        (13, '1013Э', '2023-05-05 13:45:00.000000', null, 'Согласование дополнительных спецификаций', null, 2, 3, null, 3, null),
        (47, '1047Э', '2023-03-18 09:30:00.000000', null, 'По вопросу оптимизации энергопотребления', null, 1, 10, null, 3, null),
        (18, '1018Э', '2023-05-15 10:30:00.000000', null, 'Согласование изменений в спецификации материалов', null, 3, 2, null, 3, null),
        (35, '1035Э', '2023-01-08 13:00:00.000000', null, 'О предоставлении технической спецификации', null, 1, 9, null, 3, null),
        (33, '1033Э', '2023-02-28 15:00:00.000000', null, 'Запрос на обновление технической документации', null, 2, 6, null, 3, null),
        (32, '1032Э', '2023-04-17 12:45:00.000000', null, 'О необходимости доработки программного обеспечения', null, 4, 3, null, 3, null),
        (7, '1007Э', '2023-02-18 15:45:00.000000', null, 'Согласование структуры изделия', null, 1, 6, null, 3, null),
        (30, '1030Э', '2023-01-18 16:30:00.000000', null, 'Запрос на расчет прочности сварных соединений', null, 3, 7, null, 3, null),
        (26, '1026Э', '2023-03-20 11:30:00.000000', null, 'Запрос на разработку технической спецификации', null, 3, 2, null, 3, null),
        (19, '1019Э', '2023-01-05 13:00:00.000000', null, 'О предоставлении расчетной документации', null, 1, 9, null, 3, null),
        (23, '1023Э', '2023-01-22 15:45:00.000000', null, 'Запрос на уточнение размеров детали', null, 1, 3, null, 3, null),
        (50, '1050Э', '2023-05-15 10:30:00.000000', null, 'Согласование изменений в комплектующих изделий', null, 3, 1, null, 3, null),
        (43, '1043Э', '2023-04-22 14:00:00.000000', null, 'О проведении совещания по выбору поставщика', null, 1, 5, null, 3, null),
        (41, '1041Э', '2023-01-15 09:00:00.000000', null, 'По вопросу модификации электронной схемы', null, 2, 9, null, 3, null),
        (40, '1040Э', '2023-05-10 12:00:00.000000', null, 'Согласование дизайна внешнего вида продукта', null, 4, 6, null, 3, null),
        (2, '1002Э', '2023-03-05 14:45:00.000000', null, 'Запрос на техническую спецификацию', null, 3, 8, null, 3, null),
        (4, '1004Э', '2023-01-20 16:15:00.000000', null, 'О необходимости проведения испытаний', null, 4, 9, null, 3, null),
        (29, '1029Э', '2023-05-08 13:45:00.000000', null, 'Согласование изменений в комплектации', null, 2, 4, null, 3, null),
        (27, '1027Э', '2023-04-28 14:00:00.000000', null, 'О проведении совещания по обновлению стандартов', null, 1, 5, null, 3, null),
        (25, '1025Э', '2023-01-12 09:00:00.000000', null, 'По вопросу улучшения электрической цепи', null, 2, 9, null, 3, null),
        (31, '1031Э', '2023-03-25 09:30:00.000000', null, 'По вопросу оптимизации производственных ресурсов', null, 1, 10, null, 3, null),
        (45, '1045Э', '2023-05-05 13:45:00.000000', null, 'Согласование изменений в компоновке изделия', null, 2, 4, null, 3, null),
        (44, '1044Э', '2023-02-13 10:15:00.000000', null, 'Запрос на предоставление технических расчетов', null, 4, 8, null, 3, null),
        (46, '1046Э', '2023-01-20 16:30:00.000000', null, 'Запрос на проведение анализа прочности', null, 3, 7, null, 3, null),
        (48, '1048Э', '2023-04-10 12:45:00.000000', null, 'О необходимости доработки инженерных решений', null, 4, 3, null, 3, null),
        (8, '1008Э', '2023-05-10 12:00:00.000000', null, 'Запрос на изменение материалов', null, 4, 1, null, 3, null),
        (15, '1015Э', '2023-03-22 09:30:00.000000', null, 'По вопросу оптимизации производственных процессов', null, 1, 6, null, 3, null),
        (9, '1009Э', '2023-01-10 09:00:00.000000', null, 'По вопросу улучшения электрической схемы', null, 2, 2, null, 3, null),
        (21, '1021Э', '2023-02-13 10:00:00.000000', null, 'По вопросу применения нового материала', null, 2, 7, null, 3, null),
        (22, '1022Э', '2023-04-08 13:30:00.000000', null, 'О необходимости проведения проверки прототипа', null, 3, 1, null, 3, null),
        (11, '1011Э', '2023-04-25 14:00:00.000000', null, 'Запрос на разработку 3D-модели', null, 1, 4, 8, 3, true),
        (49, '1049Э', '2023-02-23 15:00:00.000000', null, 'Запрос на обновление проектной документации', null, 2, 6, null, 3, true),
        (12, '1012Э', '2023-02-08 10:15:00.000000', null, 'О предоставлении технической документации', null, 4, 7, null, 3, true),
        (39, '1039Э', '2023-01-25 15:45:00.000000', null, 'Запрос на уточнение параметров покрытия', null, 1, 3, 7, 3, true),
        (36, '1036Э', '2023-03-22 16:15:00.000000', null, 'Запрос на разработку детального чертежа', null, 4, 4, null, 3, true),
        (37, '1037Э', '2023-02-05 10:00:00.000000', null, 'По вопросу применения новой технологии', null, 2, 7, null, 3, true);
COMMIT;
...
insert into public.distributed_to_user (id_mail, id_user, ctid)
values  (10, 157, '(0,1)'),
        (15, 157, '(0,2)'),
        (20, 157, '(0,3)');
COMMIT;
